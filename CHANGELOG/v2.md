...
Releases from the v2.1 Foundation milestone through v2.5 Hardening & ECU.
Newer entries are in [v3.md](v3.md). The top-level
[../CHANGELOG.md](../CHANGELOG.md) indexes both.
