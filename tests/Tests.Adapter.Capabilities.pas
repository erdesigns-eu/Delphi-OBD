...
type
  ...
  public
    /// <summary>
    ///   E l m327 does not claim c a n f d.
    /// </summary>
    [Test] procedure ELM327DoesNotClaimCANFD;
    /// <summary>
    ///   O b d link e x claims c a n f d.
    /// </summary>
    [Test] procedure OBDLinkEXClaimsCANFD;
    /// <summary>
    ///   Do i p gateway has no k line.
    /// </summary>
    [Test] procedure DoIPGatewayHasNoKLine;
    /// <summary>
    ///   Unknown adapter returns false.
    /// </summary>
    [Test] procedure UnknownAdapterReturnsFalse;
    /// <summary>
    ///   Resolve iso tp falls back to seven.
    /// </summary>
    [Test] procedure ResolveIsoTpFallsBackToSeven;
    /// <summary>
    ///   Resolve iso tp returns sixty two for c a n f d adapter.
    /// </summary>
...
//------------------------------------------------------------------------------
// RESOLVE ISO TP RETURNS SIXTY TWO FOR CANFDADAPTER
//------------------------------------------------------------------------------
