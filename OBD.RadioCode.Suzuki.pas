//------------------------------------------------------------------------------
// UNIT           : OBD.RadioCode.Suzuki.pas
// CONTENTS       : Suzuki Radio Code Calculator
// VERSION        : 1.0
...
function TOBDRadioCodeSuzuki.GetDescription: string;
begin
  Result := 'Calculate radio code for Suzuki radios.';
end;

function TOBDRadioCodeSuzuki.Validate(const Input: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
begin
  Result := True;
...
function TOBDRadioCodeSuzuki.Calculate(const Input: string; var Output: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
  D1, D2, D3, D4: Integer;
