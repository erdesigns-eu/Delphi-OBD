...
//  OBD.OEM.Mahindra
//
//  Mahindra & Mahindra Ltd. OEM extension. Catalogue + DTC
//  overlay in <c>catalogs/mahindra.json</c> +
//  <c>catalogs/dtc-mahindra.json</c>.
//
...
type
  /// <summary>Mahindra OEM extension.</summary>
...
function TOBDOEMExtensionMahindra.ApplicableToVIN(
...
begin
  case DID of
    ...
    $F1A0, $F1A2, $F1A4:
      ...
      begin
        case DID of
          $F1A0: FieldName := 'mahindra_model_code';
          $F1A2: FieldName := 'mahindra_variant_code';
          $F1A4: FieldName := 'mahindra_engine_code';
        else
          FieldName := 'unknown';
        end;
        Result := Format('%s = "%s"',
