...
//  OBD.OEM.BYD
//
//  BYD Auto Co. Ltd. OEM extension. Catalogue + DTC overlay in
//  <c>catalogs/byd.json</c> + <c>catalogs/dtc-byd.json</c>.
//
...
type
  /// <summary>BYD OEM extension.</summary>
...
function TOBDOEMExtensionBYD.ApplicableToVIN(
...
begin
  case DID of
    ...
    $F1A0, $F1A2:
      ...
      begin
        case DID of
          $F1A0: FieldName := 'byd_model_code';
          $F1A2: FieldName := 'byd_battery_pack_id';
        else
          FieldName := 'unknown';
        end;
        Result := Format('%s = "%s"',
