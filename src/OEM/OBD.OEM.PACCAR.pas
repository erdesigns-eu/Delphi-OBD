...
function TOBDOEMExtensionPACCAR.ApplicableToVIN(
...
procedure TOBDOEMExtensionPACCAR.SeedDefaultDtcCatalog(
  Cat: TOBDDtcCatalog);
begin
  inherited;
...
begin
  case DID of
    ...
    $F1A0, $F1A2:
      ...
      begin
        case DID of
          $F1A0: FieldName := 'paccar_chassis_code';
          $F1A2: FieldName := 'paccar_factory_code';
        else
          FieldName := 'unknown';
        end;
        Result := Format('%s = "%s"',
