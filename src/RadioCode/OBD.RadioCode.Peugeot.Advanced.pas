...
// CONTENTS       : Peugeot Radio Code Calculator - Advanced Multi-Variant
// VERSION        : 2.0
...
type
  /// <summary>
  ///   Peugeot Advanced Radio Code Calculator with Multiple Algorithm Variants
  /// </summary>
...
begin
  inherited Create;
  FVariantManager := TRadioCodeVariantManager.Create('Peugeot Advanced');
  InitializeVariants;
...
begin
  ...
  if (FCurrentVariant.VariantID = 'PEUGEOT_EU_V1') or
     (FCurrentVariant.VariantID = 'PEUGEOT_NA') then
    Output := CalculateV1(Sanitized)
  else if (FCurrentVariant.VariantID = 'PEUGEOT_EU_V2') or
          (FCurrentVariant.VariantID = 'PEUGEOT_ASIA') then
    Output := CalculateV2(Sanitized)
  else if FCurrentVariant.VariantID = 'PEUGEOT_EU_V3' then
