//------------------------------------------------------------------------------
// UNIT           : OBD.RadioCode.Honda.pas
// CONTENTS       : Honda Radio Code Calculator (Alpine/Panasonic)
// VERSION        : 1.0
...
type
  /// <summary>
  ///   Honda Radio Code Calculator (Alpine/Panasonic models)
  /// </summary>
...
function TOBDRadioCodeHonda.GetDescription: string;
begin
  Result := 'Calculate radio code for Honda radio''s (Alpine, Panasonic).';
end;

function TOBDRadioCodeHonda.Validate(const Input: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
begin
  Result := True;
...
function TOBDRadioCodeHonda.Calculate(const Input: string; var Output: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
  SerialDigits: string;
  Serial: Integer;
