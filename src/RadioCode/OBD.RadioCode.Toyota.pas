//------------------------------------------------------------------------------
// UNIT           : OBD.RadioCode.Toyota.pas
// CONTENTS       : Toyota/Lexus Radio Code Calculator
// VERSION        : 1.0
...
type
  /// <summary>
  ///   Toyota/Lexus Radio Code Calculator (Fujitsu Ten/Panasonic/Denso)
  /// </summary>
...
function TOBDRadioCodeToyota.GetDescription: string;
begin
  Result := 'Calculate radio code for Toyota/Lexus radio''s (Fujitsu Ten, Panasonic, Denso).';
end;

function TOBDRadioCodeToyota.Validate(const Input: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
begin
  Result := True;
...
function TOBDRadioCodeToyota.Calculate(const Input: string; var Output: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
  Serial: Integer;
