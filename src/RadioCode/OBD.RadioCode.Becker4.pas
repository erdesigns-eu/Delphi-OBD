...
//------------------------------------------------------------------------------
type
  /// <summary>OBD Becker RadioCode Calculator (4 Digits). The serial-to-code
  /// table (10,000 entries) is loaded from catalogs/radiocode-becker4.json
...
const
  CatalogFileName = 'radiocode-becker4.json';
  TableSize = 10000;
...
begin
  ...
  if not GLoaded then
  begin
    ErrorMessage := 'Becker4 code catalog not loaded; expected '
