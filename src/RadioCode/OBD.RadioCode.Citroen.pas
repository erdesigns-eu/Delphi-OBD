//------------------------------------------------------------------------------
// UNIT           : OBD.RadioCode.Citroen.pas
// CONTENTS       : Citroen Radio Code Calculator
// VERSION        : 1.0
...
function TOBDRadioCodeCitroen.GetDescription: string;
begin
  Result := 'Calculate radio code for Citroen radios (Blaupunkt, VDO).';
end;

function TOBDRadioCodeCitroen.Validate(const Input: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
begin
  Result := True;
...
function TOBDRadioCodeCitroen.Calculate(const Input: string; var Output: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
  D1, D2, D3, D4: Integer;
