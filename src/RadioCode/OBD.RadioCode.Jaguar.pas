//------------------------------------------------------------------------------
// UNIT           : OBD.RadioCode.Jaguar.pas
// CONTENTS       : Jaguar Radio Code Calculator (Visteon/Harman systems)
// VERSION        : 1.0
...
type
  /// <summary>
  ///   Jaguar Radio Code Calculator (Visteon, Harman, Alpine)
  /// </summary>
  /// <remarks>
  ///   Jaguar shares systems with Land Rover (JG prefix)
  ///   Format: 14 characters (JG + 12 alphanumeric)
  /// </remarks>
...
function TOBDRadioCodeJaguar.GetDescription: string;
begin
  Result := 'Calculate radio code for Jaguar radio''s (Visteon, Harman, Alpine, Navigation).';
end;

function TOBDRadioCodeJaguar.Validate(const Input: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
begin
  Result := True;
...
function TOBDRadioCodeJaguar.Calculate(const Input: string; var Output: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
  SerialPart: string;
  Sum: Integer;
