//------------------------------------------------------------------------------
// UNIT           : OBD.RadioCode.Chrysler.pas
// CONTENTS       : Chrysler/Jeep/Dodge Radio Code Calculator
// VERSION        : 1.0
...
function TOBDRadioCodeChrysler.GetDescription: string;
begin
  Result := 'Calculate radio code for Chrysler/Jeep/Dodge radios.';
end;

function TOBDRadioCodeChrysler.Validate(const Input: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
begin
  Result := True;
...
function TOBDRadioCodeChrysler.Calculate(const Input: string; var Output: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
  D1, D2, D3, D4: Integer;
