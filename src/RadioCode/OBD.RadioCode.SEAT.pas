//------------------------------------------------------------------------------
// UNIT           : OBD.RadioCode.SEAT.pas
// CONTENTS       : SEAT Radio Code Calculator
// VERSION        : 1.0
...
function TOBDRadioCodeSEAT.GetDescription: string;
begin
  Result := 'Calculate radio code for SEAT radios (similar to VW/Audi).';
end;

function TOBDRadioCodeSEAT.Validate(const Input: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
begin
  Result := True;
...
function TOBDRadioCodeSEAT.Calculate(const Input: string; var Output: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
