//------------------------------------------------------------------------------
// UNIT           : OBD.RadioCode.Volvo.pas
// CONTENTS       : Volvo Radio Code Calculator
// VERSION        : 1.0
...
function TOBDRadioCodeVolvo.GetDescription: string;
begin
  Result := 'Calculate radio code for Volvo radios (SC and HU series).';
end;

function TOBDRadioCodeVolvo.Validate(const Input: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
begin
  Result := True;
...
function TOBDRadioCodeVolvo.Calculate(const Input: string; var Output: string; var ErrorMessage: string): Boolean;
var
  Sanitized: string;
  Serial: Integer;
