...
// CONTENTS       : Per-monitor drive-cycle advisor. Given a TWWHOBDReadinessSet
//                : and an optional OEM key, returns a list of human-readable
//                : drive-cycle steps the operator still needs to complete to
//                : flip every Supported-but-not-Complete monitor to Complete.
//
// Spec ref       : ISO 15031-7 generic OBD-II drive cycle. Per-OEM drive
//                : cycles are documented in service info; the registry
//                : here covers the well-known generic procedure plus a
//                : few representative OEMs and falls back to the generic
//                : cycle for unregistered OEMs.
//------------------------------------------------------------------------------
