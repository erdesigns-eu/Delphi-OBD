...
function TOBDOEMExtensionGreatWall.ApplicableToVIN(const VIN: string): Boolean;
begin
  // JSON-only: applicable_wmis lives in gwm.json.
...
begin
  // JSON-only — sole sources of truth are gwm.json
