...
type
  /// <summary>Toyota flash handshake helper.</summary>
  TOBDFlashHandshakeToyota = class(TOBDFlashHandshake)
  strict private
    FSecurityLevel: Byte;
...
constructor TOBDFlashHandshakeToyota.Create(AOwner: TComponent);
begin
...
function TOBDFlashHandshakeToyota.GetVendorName: string;
begin
  Result := 'Toyota / Lexus / Daihatsu';
end;
